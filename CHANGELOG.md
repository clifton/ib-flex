...
### Fixed
- update Flex Web Service endpoint (#12) ([#12](https://github.com/clifton/ib-flex/pull/12))
## [0.1.8] - 2026-05-28
...
### Added
- add comprehensive daily analysis example (#10) ([#10](https://github.com/clifton/ib-flex/pull/10))
...
### Added
- Enhanced type safety and derivative field consolidation for options and futures ([#9](https://github.com/clifton/ib-flex/pull/9))
## [0.1.5] - 2026-01-14
